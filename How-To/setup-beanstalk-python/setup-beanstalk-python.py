...
globalVars['CIDRange']              = "10.246.0.0/24"
globalVars['tagName']               = "miztiik-demo-06-beanstalk"
globalVars['EC2-AMI-ID']            = "ami-cdbdd7a2"
globalVars['EC2-InstanceType']      = "t2.micro"
globalVars['EC2-KeyName']           = "beanstalk6-key"
globalVars['Log-GroupName']         = "miztiik-demo-06-beanstalk"
globalVars['IAM-RoleName']          = "miztiik-demo-06-beanstalk-role"
...
# AZ1 Subnets
az1_pvtsubnet   = vpc.create_subnet( CidrBlock = '10.246.0.0/25'   , AvailabilityZone = globalVars['AZ1'] )
az1_pubsubnet   = vpc.create_subnet( CidrBlock = '10.246.0.128/26' , AvailabilityZone = globalVars['AZ1'] )
az1_sparesubnet = vpc.create_subnet( CidrBlock = '10.246.0.192/26' , AvailabilityZone = globalVars['AZ1'] )
